...
using TBCWebApi.Repository.database.Configuration;

namespace TBCWebApi.Repository;

public class TBCWebApiDbContext : DbContext
{
    public TBCWebApiDbContext(DbContextOptions options) : base(options)
    {
